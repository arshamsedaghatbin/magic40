  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="magic40App.category.home.createOrEditLabel" data-cy="CategoryCreateUpdateHeading">
            <Translate contentKey="magic40App.category.home.createOrEditLabel">Create or edit a Category</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('magic40App.category.title')} id="category-title" name="title" data-cy="title" type="text" />
              <ValidatedField
                label={translate('magic40App.category.photoUrl')}
              ...
              />
              <ValidatedBlobField
                label={translate('magic40App.category.photo')}
                id="category-photo"
                name="photo"
                data-cy="photo"
              ...
              />
              <ValidatedField
                label={translate('magic40App.category.voiceUrl')}
              ...
              />
              <ValidatedBlobField
                label={translate('magic40App.category.voiceFile')}
              ...
              />
              <ValidatedField
                label={translate('magic40App.category.description')}
              ...
              />
              <ValidatedField
                label={translate('magic40App.category.advice')}
                id="category-advice"
                name="advice"
                data-cy="advice"
                type="text"
              />
              <ValidatedField
                label={translate('magic40App.category.accountType')}
              ...
              <ValidatedField
                label={translate('magic40App.category.action')}
                id="category-action"
                data-cy="action"
                type="select"
                multiple
