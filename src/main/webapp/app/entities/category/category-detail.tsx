    ...
    <Row>
      <Col md="8">
        <h2 data-cy="categoryDetailsHeading">
          <Translate contentKey="magic40App.category.detail.title">Category</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="title">
              <Translate contentKey="magic40App.category.title">Title</Translate>
            </span>
          </dt>
          <dd>{categoryEntity.title}</dd>
          <dt>
            <span id="photoUrl">
              <Translate contentKey="magic40App.category.photoUrl">Photo Url</Translate>
            </span>
          </dt>
          <dd>{categoryEntity.photoUrl}</dd>
          <dt>
            <span id="photo">
              <Translate contentKey="magic40App.category.photo">Photo</Translate>
            </span>
          </dt>
          <dd>
          ...
          <dt>
            <span id="voiceUrl">
              <Translate contentKey="magic40App.category.voiceUrl">Voice Url</Translate>
            </span>
          </dt>
          <dd>{categoryEntity.voiceUrl}</dd>
          <dt>
            <span id="voiceFile">
              <Translate contentKey="magic40App.category.voiceFile">Voice File</Translate>
            </span>
          </dt>
          <dd>
          ...
          <dt>
            <span id="description">
              <Translate contentKey="magic40App.category.description">Description</Translate>
            </span>
          </dt>
          <dd>{categoryEntity.description}</dd>
          <dt>
            <span id="advice">
              <Translate contentKey="magic40App.category.advice">Advice</Translate>
            </span>
          </dt>
          <dd>{categoryEntity.advice}</dd>
          <dt>
            <span id="accountType">
              <Translate contentKey="magic40App.category.accountType">Account Type</Translate>
            </span>
          </dt>
          <dd>{categoryEntity.accountType}</dd>
          <dt>
            <Translate contentKey="magic40App.category.action">Action</Translate>
          </dt>
          <dd>
