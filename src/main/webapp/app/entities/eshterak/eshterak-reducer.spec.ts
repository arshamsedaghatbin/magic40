...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './eshterak.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ESHTERAK_LIST actions', async () => {
    ...
    it('dispatches FETCH_ESHTERAK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ESHTERAK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ESHTERAK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ESHTERAK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ESHTERAK actions', async () => {
      const expectedActions = [
        {
