    ...
    <Row>
      <Col md="8">
        <h2 data-cy="practiceDetailsHeading">
          <Translate contentKey="magic40App.practice.detail.title">Practice</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="title">
              <Translate contentKey="magic40App.practice.title">Title</Translate>
            </span>
          </dt>
          <dd>{practiceEntity.title}</dd>
          <dt>
            <span id="photoUrl">
              <Translate contentKey="magic40App.practice.photoUrl">Photo Url</Translate>
            </span>
          </dt>
          <dd>{practiceEntity.photoUrl}</dd>
          <dt>
            <span id="photo">
              <Translate contentKey="magic40App.practice.photo">Photo</Translate>
            </span>
          </dt>
          <dd>
          ...
          <dt>
            <span id="voiceUrl">
              <Translate contentKey="magic40App.practice.voiceUrl">Voice Url</Translate>
            </span>
          </dt>
          <dd>{practiceEntity.voiceUrl}</dd>
          <dt>
            <span id="voiceFile">
              <Translate contentKey="magic40App.practice.voiceFile">Voice File</Translate>
            </span>
          </dt>
          <dd>
          ...
          <dt>
            <span id="masterAdvice">
              <Translate contentKey="magic40App.practice.masterAdvice">Master Advice</Translate>
            </span>
          </dt>
          ...
          <dt>
            <span id="accountType">
              <Translate contentKey="magic40App.practice.accountType">Account Type</Translate>
            </span>
          </dt>
