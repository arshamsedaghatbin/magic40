    ...
    <Row>
      <Col md="8">
        <h2 data-cy="subCategoryDetailsHeading">
          <Translate contentKey="magic40App.subCategory.detail.title">SubCategory</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="title">
              <Translate contentKey="magic40App.subCategory.title">Title</Translate>
            </span>
          </dt>
          <dd>{subCategoryEntity.title}</dd>
          <dt>
            <span id="photoUrl">
              <Translate contentKey="magic40App.subCategory.photoUrl">Photo Url</Translate>
            </span>
          </dt>
          <dd>{subCategoryEntity.photoUrl}</dd>
          <dt>
            <span id="photo">
              <Translate contentKey="magic40App.subCategory.photo">Photo</Translate>
            </span>
          </dt>
          <dd>
          ...
          <dt>
            <span id="voiceUrl">
              <Translate contentKey="magic40App.subCategory.voiceUrl">Voice Url</Translate>
            </span>
          </dt>
          <dd>{subCategoryEntity.voiceUrl}</dd>
          <dt>
            <span id="voiceFile">
              <Translate contentKey="magic40App.subCategory.voiceFile">Voice File</Translate>
            </span>
          </dt>
          <dd>
          ...
          <dt>
            <span id="masterAdvice">
              <Translate contentKey="magic40App.subCategory.masterAdvice">Master Advice</Translate>
            </span>
          </dt>
          <dd>{subCategoryEntity.masterAdvice}</dd>
          <dt>
            <span id="accountType">
              <Translate contentKey="magic40App.subCategory.accountType">Account Type</Translate>
            </span>
          </dt>
          <dd>{subCategoryEntity.accountType}</dd>
          <dt>
            <Translate contentKey="magic40App.subCategory.action">Action</Translate>
          </dt>
          <dd>
          ...
          <dt>
            <Translate contentKey="magic40App.subCategory.category">Category</Translate>
          </dt>
