  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="magic40App.subCategory.home.createOrEditLabel" data-cy="SubCategoryCreateUpdateHeading">
            <Translate contentKey="magic40App.subCategory.home.createOrEditLabel">Create or edit a SubCategory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('magic40App.subCategory.title')}
              ...
              />
              <ValidatedField
                label={translate('magic40App.subCategory.photoUrl')}
              ...
              />
              <ValidatedBlobField
                label={translate('magic40App.subCategory.photo')}
              ...
              />
              <ValidatedField
                label={translate('magic40App.subCategory.voiceUrl')}
              ...
              />
              <ValidatedBlobField
                label={translate('magic40App.subCategory.voiceFile')}
              ...
              />
              <ValidatedField
                label={translate('magic40App.subCategory.masterDescription')}
              ...
              />
              <ValidatedField
                label={translate('magic40App.subCategory.masterAdvice')}
              ...
              />
              <ValidatedField
                label={translate('magic40App.subCategory.accountType')}
              ...
              <ValidatedField
                label={translate('magic40App.subCategory.action')}
              ...
              <ValidatedField
                ...
                name="categoryId"
                data-cy="category"
                label={translate('magic40App.subCategory.category')}
                type="select"
              >
                <option value="" key="0" />
                {categories
