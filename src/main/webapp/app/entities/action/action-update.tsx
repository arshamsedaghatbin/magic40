  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="magic40App.action.home.createOrEditLabel" data-cy="ActionCreateUpdateHeading">
            <Translate contentKey="magic40App.action.home.createOrEditLabel">Create or edit a Action</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('magic40App.action.title')} id="action-title" name="title" data-cy="title" type="text" />
              <ValidatedField
                label={translate('magic40App.action.photoUrl')}
                id="action-photoUrl"
                name="photoUrl"
                data-cy="photoUrl"
                type="text"
              />
              <ValidatedBlobField
                label={translate('magic40App.action.photo')}
                id="action-photo"
                name="photo"
                data-cy="photo"
              ...
              />
              <ValidatedField
                label={translate('magic40App.action.code')}
                id="action-code"
                name="code"
                data-cy="code"
                type="text"
              ...
              />
              <ValidatedBlobField
                label={translate('magic40App.action.video')}
                id="action-video"
                name="video"
                data-cy="video"
                openActionLabel={translate('entity.action.open')}
              />
              <ValidatedField
                label={translate('magic40App.action.videoUrl')}
                id="action-videoUrl"
                name="videoUrl"
                data-cy="videoUrl"
                type="text"
              />
              <ValidatedField
                label={translate('magic40App.action.masterDescription')}
              ...
              />
              <ValidatedField
                label={translate('magic40App.action.accountType')}
