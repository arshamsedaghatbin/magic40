...
export const BookMarkActionDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="magic40App.bookMarkAction.delete.question">
        <Translate contentKey="magic40App.bookMarkAction.delete.question" interpolate={{ id: bookMarkActionEntity.id }}>
