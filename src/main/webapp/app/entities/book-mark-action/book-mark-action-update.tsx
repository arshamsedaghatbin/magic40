  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="magic40App.bookMarkAction.home.createOrEditLabel" data-cy="BookMarkActionCreateUpdateHeading">
            <Translate contentKey="magic40App.bookMarkAction.home.createOrEditLabel">Create or edit a BookMarkAction</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('magic40App.bookMarkAction.userDescription')}
              ...
              <ValidatedField
                ...
                name="actionId"
                data-cy="action"
                label={translate('magic40App.bookMarkAction.action')}
                type="select"
              >
                <option value="" key="0" />
                {actions
