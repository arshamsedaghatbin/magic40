    ...
    <Row>
      <Col md="8">
        <h2 data-cy="bookMarkActionDetailsHeading">
          <Translate contentKey="magic40App.bookMarkAction.detail.title">BookMarkAction</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="magic40App.bookMarkAction.action">Action</Translate>
          </dt>
