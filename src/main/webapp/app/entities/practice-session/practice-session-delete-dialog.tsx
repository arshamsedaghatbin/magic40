...
export const PracticeSessionDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="magic40App.practiceSession.delete.question">
        <Translate contentKey="magic40App.practiceSession.delete.question" interpolate={{ id: practiceSessionEntity.id }}>
