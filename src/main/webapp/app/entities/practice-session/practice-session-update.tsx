  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="magic40App.practiceSession.home.createOrEditLabel" data-cy="PracticeSessionCreateUpdateHeading">
            <Translate contentKey="magic40App.practiceSession.home.createOrEditLabel">Create or edit a PracticeSession</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('magic40App.practiceSession.tiltle')}
              ...
              />
              <ValidatedField
                label={translate('magic40App.practiceSession.action')}
              ...
              <ValidatedField
                ...
                name="practiceId"
                data-cy="practice"
                label={translate('magic40App.practiceSession.practice')}
                type="select"
              >
                <option value="" key="0" />
                {practices
