    ...
    <Row>
      <Col md="8">
        <h2 data-cy="practiceSessionDetailsHeading">
          <Translate contentKey="magic40App.practiceSession.detail.title">PracticeSession</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="tiltle">
              <Translate contentKey="magic40App.practiceSession.tiltle">Tiltle</Translate>
            </span>
          </dt>
          <dd>{practiceSessionEntity.tiltle}</dd>
          <dt>
            <Translate contentKey="magic40App.practiceSession.action">Action</Translate>
          </dt>
          <dd>
          ...
          <dt>
            <Translate contentKey="magic40App.practiceSession.practice">Practice</Translate>
          </dt>
